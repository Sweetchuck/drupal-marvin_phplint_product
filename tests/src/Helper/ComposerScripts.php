...
namespace Drupal\Tests\marvin_phplint_product\Helper;
...
class ComposerScripts {
  ...
  protected string $projectNameSnake = 'marvin_phplint_product';

  protected string $projectNameDash = 'marvin-phplint-product';
          ...
          'drush' => [
            'paths' => [
              'config' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/contrib/marvin_phplint/Commands/drush.yml",
              ...
              'include' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/contrib/marvin_phplint",
